    ...
    private suspend fun print(): Boolean {
        ...
        try {
            ...
            try {
                ...
                val db = com.printerswanqara.data.database.DatabaseProvider.getDatabase(this)
                Log.d("BackgroundActivity", "Database instance obtained: $db")
                val repository = com.printerswanqara.data.database.repositories.PrinterRepository(db.printersDAO())
