            ...
            if (printerBuilder != null) {
                ...
                try {
                    ...
                    val request = when (command) {
                        "IMPRESION_FACTURA_ELECTRONICA" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData, printType = "01", openDrawer = true)
                        "IMPRESION_RECIBO" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData, printType = "03", openDrawer = true)
                        "IMPRESION_PRE_TICKET" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData)
                        "IMPRESION_COTIZACION" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData)
                        "IMPRESION_CIERRE_CAJA" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData)
                        "IMPRESION_COMANDA:COCINA" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData)
                        "IMPRESION_COMANDA:BARRA" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData)
                        "IMPRESION_COMANDA:OTROS" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData)
                        "GAVETA_DINERO" -> com.printerswanqara.api.ServerPrintRequest(data = gsonData, openDrawer = true)
                        else -> null
                    }
